...
chef-server-ctl user-create admin inadev support support@inadev.com 'support@123' --filename /etc/chef/inadev.pem
chef-server-ctl org-create inadev 'Inadev Corporation' --association_user admin --filename /etc/chef/inadev-validator.pem
